// Copy from https://fanyi-cdn.cdn.bcebos.com/static/translation/pkg/index_a8b7098.js
// The `translation:widget/translate/input/pGrab` module define
// @ts-nocheck
// deno-lint-ignore-file
export function sign(text: string, gtk: string): string {
	function a(r) {
		if (Array.isArray(r)) {
